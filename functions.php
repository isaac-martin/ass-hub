...
function asshub_setup() {
  ...
  register_nav_menu( 'header', __( 'Header menu', 'asshub' ) );
  register_nav_menu( 'footer', __( 'Footer menu', 'asshub' ) );

}
add_action( 'after_setup_theme', 'asshub_setup', 11 );

// Sidebar declaration
function asshub_widgets_init() {
  register_sidebar( array(
    'name'          => __( 'Main sidebar', 'asshub' ),
    'id'            => 'sidebar-main',
    'description'   => __( 'Appears to the right side of most posts and pages.', 'asshub' ),
